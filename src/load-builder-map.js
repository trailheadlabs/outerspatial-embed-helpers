if (typeof window.OuterSpatialEmbedHelpers !== 'object') {
  console.error('window.OuterSpatialEmbedHelpers must be an object');
} else if (isNaN(window.OuterSpatialEmbedHelpers.builderMapId)) {
  console.error('window.OuterSpatialEmbedHelpers.builderMapId must be a number');
} else if (typeof window.OuterSpatialEmbedHelpers.element !== 'object') {
  console.error('window.OuterSpatialEmbedHelpers.element must be a DOM element object');
}
